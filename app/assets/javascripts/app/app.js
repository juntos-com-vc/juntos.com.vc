var App = (window.App = Skull.View.extend({
  ...
  events: {
    ...
    "click a#adus-menu": "toggleMenuAdus",
  ...
  flash: function() {
    ...
    setTimeout(function() {
      that.$flash.slideDown("slow");
    }, 100);
    if (!this.$(".flash a").length)
      setTimeout(function() {
        that.$flash.fadeOut("slow");
      }, 5000);
    $(window).click(function() {
      that.$(".flash a").slideUp();
    });
  },
  ...
  notices: function() {
    var that = this;
    setTimeout(function() {
      this.$(".notice-box").fadeIn("slow");
    }, 100);
    if (this.$(".notice-box").length)
      setTimeout(function() {
        that.$(".notice-box").fadeOut("slow");
      }, 16000);
    $(".icon-close").on("click", function() {
      that.$(".card-notification").fadeOut("slow");
    });
  },
