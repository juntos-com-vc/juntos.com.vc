...
class Project < ActiveRecord::Base
  ...
  scope :without_teste_channel, -> { joins('LEFT OUTER JOIN channels_projects ON channels_projects.project_id = projects.id LEFT OUTER JOIN channels ON channels_projects.channel_id = channels.id').where.not('"channels"."permalink" = \'teste\'') }
