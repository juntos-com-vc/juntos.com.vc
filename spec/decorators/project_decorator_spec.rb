...
RSpec.describe ProjectDecorator do
  ...
  describe "#about_html" do
    ...
    xit{ is_expected.to eq('<p>Foo Bar <a class="alt-link" href="http://www.foo.bar" target="_blank">http://www.foo.bar</a> &lt;javascript&gt;xss()&lt;/javascript&gt;<a class="alt-link" target="_blank" href="http://click.here">Click here</a></p>')}
  end
